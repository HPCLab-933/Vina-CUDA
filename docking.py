...
class VinaDocking:
    ...
    def is_smiles(smiles_string):
        ...
        if re.match(smiles_pattern, smiles_string):
            return True
        else:
            return False
    ...
    def _batched_docking(self, paths: Iterable[str]) -> List[Union[float, None]]:
        ...
        #print(f"\n{overlap_idxs}")
        #print(f"\n{non_overlap_ligand_paths}")
        #print(f"\n{non_overlap_tmp_ligand_paths}")
        #print(f"\n{non_overlap_names}")
...
if __name__ == "__main__":
    docking_module_gpu = VinaDocking("/mnt/disk4/DingXiaoyu/Vina-GPU-2.1_new_release/QuickVina2-GPU-2.1/QuickVina2-GPU-2-1",
                                 "/mnt/disk4/DingXiaoyu/AutoDock-Vina-GPU-2-1-CUDA-V5-LCF/paper_test_file/benchmark/Uni-Dock-Benchmarks-main/data/virtual_screening/PPARG/5Y2T_receptor.pdbqt",
                                 [28.000, 3.000, 28.010],
                                 [50.0, 50.00, 50.00],
                                 "/mnt/disk4/DingXiaoyu/AutoDock-Vina-GPU-2-1-CUDA-V5-LCF/paper_test_file/benchmark/Uni-Dock-Benchmarks-main/data/virtual_screening/PPARG/activate_and_inactivate_pdbqt",
                                 ...
                                 gpu_ids=None,
                                 #additional_vina_args={"thread": "6500","opencl_binary_path" : "/mnt/disk4/DingXiaoyu/Vina-GPU-2.1_new_release/QuickVina-W-GPU-2.1"})
                                 additional_vina_args={"thread": "6500"})
    try:                         
        print(docking_module_gpu("/mnt/disk4/DingXiaoyu/AutoDock-Vina-GPU-2-1-CUDA-V5-LCF/paper_test_file/benchmark/Uni-Dock-Benchmarks-main/data/virtual_screening/PPARG/activate_and_inactivate_pdbqt"))
